...
setup(
    name='watson-assets',
    version=watson.assets.__version__,
    url='http://github.com/watsonpy/watson-assets',
    description='Manage publicly available assets within your application.',
